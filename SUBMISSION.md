...
| 3 | **Order lines** | Done | Price snapshot (`price_at_add`), quantities, dish special instructions, server-calculated running total, live dish line additions to active orders. |
...
| 9 | **History you cannot rewrite** | Done | Append-only audit trail logging all status updates, line additions, voids, and notes (uneditable). |
